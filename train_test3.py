...
csv_file = "./output/cross_weighted_test_3_epoch_400_step_5_img_512_emd_1024_head_8.csv"
...
#test 3
criterion = nn.CrossEntropyLoss(weight=torch.tensor([5, 7, 15.0, 7, 1.9])).to(device)
...
for epoch in range(total_epochs):
        ...
        lr_scheduler.step()
        torch.save(model.state_dict(), os.path.join("./output/", 'cls_weighted_test3_img_512_emd_1024_head_8_epoch_{}.pth'.format(epoch)))
